...
Version  : 3.3.2
Release  : 20
URL      : https://cran.r-project.org/src/contrib/spatstat.explore_3.3-2.tar.gz
Source0  : https://cran.r-project.org/src/contrib/spatstat.explore_3.3-2.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1724240865
