...
Source0  : https://cran.r-project.org/src/contrib/spatstat.explore_3.0-5.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1668455720
...
/usr/lib64/R/library/spatstat.explore/libs/spatstat.explore.so.avx2
/usr/lib64/R/library/spatstat.explore/libs/spatstat.explore.so.avx512
