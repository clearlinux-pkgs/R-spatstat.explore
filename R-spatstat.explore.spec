...
Version  : 3.2.5
Release  : 15
URL      : https://cran.r-project.org/src/contrib/spatstat.explore_3.2-5.tar.gz
Source0  : https://cran.r-project.org/src/contrib/spatstat.explore_3.2-5.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1698163277
